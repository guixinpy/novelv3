...
import {
  memoryTreeLlmBatchExecuteRun,
  memoryTreeLlmBatchPrepareExpectedExecutePayload,
  memoryTreeLlmBatchPrepareRun,
  memoryTreeLlmCandidateExpectedPreparePayload,
  memoryTreeLlmCandidateRun,
  memoryTreeLlmMaterializedCandidateRun,
} from './agentRunFixtures/memoryTreeLlmRuns'
import {
  memoryTreeDrilldownExpectedPayload,
  memoryTreeDrilldownRun,
  memoryTreeNodeExpandExpectedPayload,
  memoryTreeNodeExpandRun,
  memoryTreeProjectionRun,
  memoryTreeResultHistory,
  memoryTreeResultRun,
  memoryTreeSearchExpectedPayload,
  memoryTreeSearchRun,
} from './agentRunFixtures/memoryTreeRuns'
import {
  knowledgeBaseCandidateExpectedExecutePayload,
  knowledgeBaseCandidateExecuteRouteRun,
  knowledgeBaseCandidateExecuteRun,
  knowledgeBaseCandidatePrepareRun,
  knowledgeBaseCandidateRouteExpectedPayload,
  knowledgeBaseRouteRun,
  postChapterMemoryCandidateExpectedPreparePayload,
  postChapterMemoryCaptureRun,
  postChapterMemoryProjectionRun,
} from './agentRunFixtures/knowledgeBaseRuns'
import {
  executableRecoveryRun,
  executableRecommendedFollowupRun,
  guardedRecoveryRun,
  postApprovalContinuationRun,
  recommendedFollowupChapterExpectedExecutePayload,
  recommendedFollowupChapterPrepareRun,
...
describe('AgentRunDrawer', () => {
  ...
  it('renders recommended followup provenance write tools as confirmation-only suggestions', () => {
    mount(AgentRunDrawer, {
      ...
      props: {
        ...
        loading: false,
        error: '',
        run: recommendedFollowupProvenanceRun,
      },
    })
  ...
  it('renders recommended followup worker dispatch summary', () => {
    mount(AgentRunDrawer, {
      ...
      props: {
        ...
        loading: false,
        error: '',
        run: recommendedFollowupWorkerDispatchRun,
      },
    })
  ...
  it('renders post-chapter memory panel from tool output', () => {
    mount(AgentRunDrawer, {
      ...
      props: {
        ...
        loading: false,
        error: '',
        run: postChapterMemoryProjectionRun,
      },
    })
  ...
  it('emits a prepare candidate continuation from post-chapter memory capture candidates', async () => {
    const wrapper = mount(AgentRunDrawer, {
      ...
      props: {
        ...
        loading: false,
        error: '',
        run: postChapterMemoryCaptureRun,
      },
    })
    ...
    expect(wrapper.emitted('executePlannerPlan')).toEqual([[postChapterMemoryCandidateExpectedPreparePayload]])
  })
  ...
  it('emits a memory tree LLM candidate prepare continuation from inspected candidates', async () => {
    ...
    expect(wrapper.emitted('executePlannerPlan')).toEqual([[memoryTreeLlmCandidateExpectedPreparePayload]])
  })
  ...
  it('renders materialized memory tree LLM candidates without duplicate prepare actions', () => {
    mount(AgentRunDrawer, {
      ...
      props: {
        ...
        loading: false,
        error: '',
        run: memoryTreeLlmMaterializedCandidateRun,
      },
    })
  ...
  it('wires memory tree LLM candidate batch prepare execute payloads', async () => {
    const wrapper = mount(AgentRunDrawer, {
      ...
      props: {
        ...
        loading: false,
        error: '',
        run: memoryTreeLlmBatchPrepareRun,
      },
    })
    ...
    expect(wrapper.emitted('executePlannerPlan')).toEqual([[memoryTreeLlmBatchPrepareExpectedExecutePayload]])
  })
  ...
  it('renders memory tree LLM candidate batch execute panel from tool output', () => {
    mount(AgentRunDrawer, {
      ...
      props: {
        ...
        loading: false,
        error: '',
        run: memoryTreeLlmBatchExecuteRun,
      },
    })
  ...
  it('emits a read-only memory tree drilldown planner continuation from recommended drilldowns', async () => {
    ...
    expect(wrapper.emitted('executePlannerPlan')).toEqual([[memoryTreeDrilldownExpectedPayload]])
  })
  ...
  it('emits a read-only memory tree expansion from a returned node with children', async () => {
    ...
    expect(wrapper.emitted('executePlannerPlan')).toEqual([[memoryTreeNodeExpandExpectedPayload]])
  })
  ...
  it('renders memory tree navigation history without exposing internal node ids', () => {
    mount(AgentRunDrawer, {
      ...
      props: {
        ...
        loading: false,
        error: '',
        memoryTreeHistory: memoryTreeResultHistory,
        run: memoryTreeResultRun,
      },
    })
  ...
  it('emits a read-only memory tree search planner continuation from query input', async () => {
    ...
    expect(wrapper.emitted('executePlannerPlan')).toEqual([[memoryTreeSearchExpectedPayload]])
  })
  ...
  it('emits confirmed recommended followup execution payload when preview has executable tools', async () => {
    const wrapper = mount(AgentRunDrawer, {
      ...
      props: {
        ...
        loading: false,
        error: '',
        run: executableRecommendedFollowupRun,
      },
    })
  ...
  it('shows post-approval continuation tools in recommended followup policy', () => {
    mount(AgentRunDrawer, {
      ...
      props: {
        ...
        loading: false,
        error: '',
        run: postApprovalContinuationRun,
      },
    })
  ...
  it('renders prepared chapter generation approval from recommended followup execution', async () => {
    const wrapper = mount(AgentRunDrawer, {
      ...
      props: {
        ...
        loading: false,
        error: '',
        run: recommendedFollowupChapterPrepareRun,
      },
    })
    ...
    expect(wrapper.emitted('executePlannerPlan')).toEqual([[recommendedFollowupChapterExpectedExecutePayload]])
  })
  ...
  it('renders prepared knowledge base candidate approval with candidate title', async () => {
    const wrapper = mount(AgentRunDrawer, {
      ...
      props: {
        ...
        loading: false,
        error: '',
        run: knowledgeBaseCandidatePrepareRun,
      },
    })
    ...
    expect(wrapper.emitted('executePlannerPlan')).toEqual([[knowledgeBaseCandidateExpectedExecutePayload]])
  })
  ...
  it('renders knowledge base candidate execution success without internal ids', () => {
    mount(AgentRunDrawer, {
      ...
      props: {
        ...
        loading: false,
        error: '',
        run: knowledgeBaseCandidateExecuteRun,
      },
    })
  ...
  it('emits a read-only knowledge base route continuation after candidate execution', async () => {
    const wrapper = mount(AgentRunDrawer, {
      ...
      props: {
        ...
        loading: false,
        error: '',
        run: knowledgeBaseCandidateExecuteRouteRun,
      },
    })
    ...
    expect(wrapper.emitted('executePlannerPlan')).toEqual([[knowledgeBaseCandidateRouteExpectedPayload]])
  })
  ...
  it('renders trace audit panel from tool output', () => {
    mount(AgentRunDrawer, {
      attachTo: document.body,
      props: {
        open: true,

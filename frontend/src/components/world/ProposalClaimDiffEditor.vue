...
<style scoped>
.diff-editor { display: grid; gap: 0; border: 1px solid var(--color-warm-subtle); border-radius: 0.8rem; overflow: hidden; }
...
.diff-editor__badge { margin-left: auto; border-radius: 0.4rem; padding: 0.15rem 0.5rem; background: var(--color-proposal-diagram-border); color: var(--color-warning); font-size: 0.7rem; font-weight: 700; }
.diff-editor__fields { display: grid; }
.diff-editor__row { display: flex; align-items: center; gap: 0.6rem; padding: 0.55rem 0.85rem; border-bottom: 1px solid var(--color-warm-hover); }
.diff-editor__row.is-changed { background: var(--color-proposal-diagram-bg); }
.diff-editor__field-name { width: 10rem; color: var(--color-text-secondary); font-size: 0.76rem; flex-shrink: 0; }
.diff-editor__row.is-changed .diff-editor__field-name { color: var(--color-warning); font-weight: 700; }
...
.diff-editor__input, .diff-editor__textarea {
  border: 1px solid var(--color-warm-subtle); border-radius: 0.4rem;
...
.diff-editor__btn { border: 1px solid var(--color-warm-border); border-radius: 999px; padding: 0.35rem 0.7rem; background: rgba(255, 252, 246, 0.92); color: var(--color-text-secondary); font-size: 0.76rem; cursor: pointer; }

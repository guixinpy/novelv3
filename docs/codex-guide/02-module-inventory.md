...
Agent 化缺口：
  ...
  - Dogfood Evidence 已纳入 Trace anomaly threshold calibration/policy/config/review/approval-chain 证据；仍缺真实长跑 dogfood 样本采集
关联模块：所有 AI 调用模块
```

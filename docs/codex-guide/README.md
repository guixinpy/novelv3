...
2. 再看 [05-进度追踪](./05-progress-tracker.md) 确认当前任务没有被别人在做
3. 完成后更新 [05-进度追踪](./05-progress-tracker.md)
...
3. **[01-愿景与架构目标](./01-vision.md)** — 恢复方向感
4. **[04-开发规则与约束](./04-development-rules.md)** — 恢复做事方法

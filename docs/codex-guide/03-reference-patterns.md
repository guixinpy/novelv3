...
| 能力 | 借鉴来源 | 当前状态 | 优先级 |
|------|---------|---------|--------|
| 工具权限分级 | openhuman PermissionLevel | 已完成基础版：内部枚举 + 公开字符串兼容；工具契约快照可自然语言只读审计 | 已完成基础版 |

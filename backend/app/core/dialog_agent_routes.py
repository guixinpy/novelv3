...
_DIALOG_ACTION_TO_AGENT_TOOL: dict[str, str] = {
    ...
    "prepare_memory_tree_llm_candidate_summaries_batch": "prepare_record_agent_memory_tree_llm_candidate_summaries_batch",
    ...
    "inspect_retrieval_prefetch_plan": "inspect_agent_retrieval_prefetch_plan",
    ...
    "preflight_context_budget": "preflight_writing",
    ...
    "inspect_agent_event_projection": "inspect_agent_event_projection",

...
def _inspect_agent_trace_anomaly_long_run_samples(
    context: WritingAgentToolContext,
    tool: WritingAgentToolRequest,
) -> dict[str, Any]:
    from app.services.writing_agent.agent_trace_audit import inspect_agent_trace_anomaly_long_run_samples

    return inspect_agent_trace_anomaly_long_run_samples(
        context.db,
        context.project_id,
        limit=_optional_int(tool.params.get("limit")),
        chapter_index=_optional_int(tool.params.get("chapter_index")),
        minimum_review_run_count=_optional_int(tool.params.get("minimum_review_run_count")),
    )
...
def _inspect_agent_retrieval_strategy_quality(
    context: WritingAgentToolContext,
    tool: WritingAgentToolRequest,
) -> dict[str, Any]:
    from app.services.writing_agent.agent_retrieval_strategy import inspect_agent_retrieval_strategy_quality

    return inspect_agent_retrieval_strategy_quality(
        context.db,
        context.project_id,
        chapter_index=_optional_int(tool.params.get("chapter_index")),
        query=str(tool.params.get("query") or tool.command_args or "").strip() or None,
...
AGENT_MEMORY_TRACE_TOOL_ADAPTERS: dict[str, WritingAgentToolAdapter] = {
    ...
    "inspect_agent_trace_anomaly_long_run_samples": WritingAgentToolAdapter(
    ...
    "inspect_agent_retrieval_strategy": WritingAgentToolAdapter(

...
AGENT_PLAN_GATED_TOOLS = {
    ...
    "execute_record_agent_memory_tree_llm_candidate_summaries_batch_with_approval": {
        "gate_version": "phase250.memory_tree_llm_candidate_summary_agent_plan_approval.v1",
        "gate_type": "per_candidate_stateless_agent_plan_approval",
        "covered_tools": ["record_agent_memory_tree_llm_candidate_summary"],
    },
    ...
    "execute_seed_continuity_anchor_proposals_with_approval": {
        "gate_version": "phase198.continuity_anchor_seed_agent_plan_approval.v1",
        "gate_type": "stateless_agent_plan_approval",
    ...
    "execute_enqueue_longform_chapter_batch_with_approval": {
        ...
        "gate_type": "stateless_agent_plan_approval",
        "covered_tools": ["enqueue_longform_chapter_batch"],
    },
    "execute_longform_chapter_batch_preflight_with_approval": {
        "gate_version": "phase200.longform_batch_preflight_agent_plan_approval.v1",
        "gate_type": "stateless_agent_plan_approval",
        "covered_tools": ["execute_longform_chapter_batch_preflight"],
    },
    "execute_longform_chapter_batch_execution_prepare_with_approval": {
        "gate_version": "phase201.longform_batch_execution_prepare_agent_plan_approval.v1",
        "gate_type": "stateless_agent_plan_approval",
        "covered_tools": ["prepare_longform_chapter_batch_execution"],
    },
    "execute_longform_chapter_batch_execution_review_with_approval": {
        "gate_version": "phase202.longform_batch_execution_review_agent_plan_approval.v1",
        "gate_type": "stateless_agent_plan_approval",
    ...
    "execute_apply_pending_action_route_approval_opt_in_with_approval": {
        "gate_version": "phase231.route_opt_in_apply_agent_plan_approval.v1",
        "gate_type": "stateless_agent_plan_approval",
        "covered_tools": ["apply_pending_action_route_approval_opt_in"],
    },

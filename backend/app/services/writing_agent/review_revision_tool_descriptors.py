...
REVIEW_REVISION_AGENT_TOOL_DESCRIPTORS: tuple[AgentToolDescriptor, ...] = (
    ...
    AgentToolDescriptor(
        name="prepare_create_revision_draft_execution",
        module="revision",
        category="revision",
        description="为章节修订草稿创建构建 Agent 计划审批契约，不写入修订记录。",
        input_schema=_CHAPTER_PARAMS,
        ...
        target_type="revision_draft_approval",
        internal=True,
        non_blocking_report=True,
        sort_key=121,
        availability_checks=("generated_chapter_exists",),
    ...
    AgentToolDescriptor(
        name="execute_create_revision_draft_with_approval",
        module="revision",
        category="revision",
        description="在确认 Agent 计划审批契约后创建章节修订草稿。",
    ...
    AgentToolDescriptor(
        name="prepare_apply_planner_revision_patch_execution",
        module="revision",
        category="revision",
        description="为章节修订补丁应用构建 Agent 计划审批契约，不写入章节正文。",
        input_schema=object_schema(
            {"chapter_index": {"type": "integer", "minimum": 1}, "revision_id": {"type": "string"}},
            required=("chapter_index", "revision_id"),
        ),
        output_schema=object_schema(
            {
                "status": {"type": "string"},
        ...
        target_type="revision_patch_approval",
        internal=True,
        non_blocking_report=True,
        sort_key=131,
        availability_checks=("generated_chapter_exists",),
    ...
    AgentToolDescriptor(
        name="execute_apply_planner_revision_patch_with_approval",
        module="revision",
        category="revision",
        description="在确认 Agent 计划审批契约后应用章节修订补丁。",
        input_schema=object_schema(
            {
                "chapter_index": {"type": "integer", "minimum": 1},
                "revision_id": {"type": "string"},
    ...
    AgentToolDescriptor(
        name="prepare_expand_chapter_to_target_execution",
        module="revision",
        category="revision",
        description="为章节扩写构建 Agent 计划审批契约，不写入章节正文。",
        input_schema=object_schema(
            {
                "chapter_index": {"type": "integer", "minimum": 1},
                "min_word_count": {"type": "integer"},
        ...
        target_type="revision_adjustment_approval",
        internal=True,
        non_blocking_report=True,
        sort_key=141,
        availability_checks=("generated_chapter_exists",),
    ...
    AgentToolDescriptor(
        name="execute_expand_chapter_to_target_with_approval",
        module="revision",
        category="revision",
        description="在确认 Agent 计划审批契约后扩写章节正文。",
        input_schema=object_schema(
            {
                "chapter_index": {"type": "integer", "minimum": 1},
                "min_word_count": {"type": "integer"},
    ...
    AgentToolDescriptor(
        name="prepare_compress_chapter_to_target_execution",
        module="revision",
        category="revision",
        description="为章节压缩构建 Agent 计划审批契约，不写入章节正文。",
        input_schema=object_schema(
            {
                "chapter_index": {"type": "integer", "minimum": 1},
                "target_max_word_count": {"type": "integer"},
    ...
    AgentToolDescriptor(
        name="execute_compress_chapter_to_target_with_approval",
        module="revision",
        category="revision",
        description="在确认 Agent 计划审批契约后压缩章节正文。",
        input_schema=object_schema(
            {
                "chapter_index": {"type": "integer", "minimum": 1},
                "target_max_word_count": {"type": "integer"},
